...
import com.healthz.myhealthz.requestpojo.AppoinmentCloseRequest;
import com.healthz.myhealthz.requestpojo.PetNoShowRequest;
...
public class VideoCallDoctorActivity extends AppCompatActivity implements JitsiMeetActivityInterface, JitsiMeetViewListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            patientid = extras.getString("userid");
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                       // closeAppointmentNotifyResponseCall();
                        Intent intent = new Intent(getApplicationContext(), com.healthz.myhealthz.doctor.PrescriptionActivity.class);
