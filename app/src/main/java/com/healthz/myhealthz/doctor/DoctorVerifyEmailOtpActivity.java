...
import com.healthz.myhealthz.requestpojo.EmailOTPRequest;
import com.healthz.myhealthz.responsepojo.EmailOTPResponse;
...
public class DoctorVerifyEmailOtpActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId()){
            ...
            case R.id.img_back:
                ...
                case R.id.txt_resend:
                    if (new ConnectionDetector(DoctorVerifyEmailOtpActivity.this).isNetworkAvailable(DoctorVerifyEmailOtpActivity.this)) {
                        if(useremail != null){
    ...
    public void verifyValidator() {
        ...
        String responseotp = String.valueOf(otp);
         ...
         if (can_proceed) {
             Intent intent = new Intent(DoctorVerifyEmailOtpActivity.this, DoctorEditProfileActivity.class);
