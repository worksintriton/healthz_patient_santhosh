package com.healthz.myhealthz.petlover.myaddresses;
...
import com.healthz.myhealthz.petlover.ShippingAddressAddActivity;
import com.healthz.myhealthz.requestpojo.ShippingAddressEditRequest;
import com.healthz.myhealthz.responsepojo.CartDetailsResponse;
import com.healthz.myhealthz.responsepojo.ShippingAddressEditResponse;
...
public class MyAddressEditActivity extends AppCompatActivity implements View.OnClickListener {

    private String TAG = "MyAddressEditActivity";
    ...
    private void gotoPreviousActivity() {
        ...
        if(fromactivity.equals("ShippingAddressActivity")){
            ...
            Intent intent = new Intent(MyAddressEditActivity.this, ShippingAddressActivity.class);
            ...
            Intent intent = new Intent(MyAddressEditActivity.this, ShippingAddressAddActivity.class);
            ...
            public void onResponse(@NonNull Call<ShippingAddressEditResponse> call, @NonNull Response<ShippingAddressEditResponse> response) {
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                        ...
                        Toasty.warning(MyAddressEditActivity.this,"Server Issue",Toasty.LENGTH_LONG).show();
                    }
                }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(getApplicationContext(),MyAddressesListActivity.class));
        finish();
      //  gotoPreviousActivity();
    }
}