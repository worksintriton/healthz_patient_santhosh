...
import com.healthz.myhealthz.petlover.PetAppointmentDetailsActivity;
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
       ...
       if(newAppointmentResponseList.get(position).getPet_name() != null) {
        ...
        if(newAppointmentResponseList.get(position).getAppointment_for() != null && newAppointmentResponseList.get(position).getAppointment_for().equalsIgnoreCase("Doctor") ){
            if(newAppointmentResponseList.get(position).getAppointment_type() != null) {
                holder.txt_type.setText(newAppointmentResponseList.get(position).getAppointment_type());
            }
