...
public class MyFamilyListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private String TAG = "MyFamilyListAdapter";


    public MyFamilyListAdapter(Context context, List<FamilyMemberListResponse.DataBean> petListResponseList, MyPetsSelectListener myPetsSelectListener) {
        ...
        holder.ll_pet_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(petListResponseList.get(position).get_id() != null ){
                    myPetsSelectListener.myPetsSelectListener(petListResponseList.get(position).get_id(),petListResponseList.get(position).getName());
