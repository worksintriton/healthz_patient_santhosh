...
import com.healthz.myhealthz.serviceprovider.SPMyCalendarTimeActivity;

import java.util.List;


public class SPMyCalendarTimeAvailableAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "SPMyCalendarTimeAvailableAdapter";
