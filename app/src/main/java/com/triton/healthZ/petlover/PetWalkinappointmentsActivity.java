...
import com.triton.healthZ.fragmentpetlover.walkinappointments.FragmentPetWalkinNewAppointment;
import com.triton.healthZ.fragmentpetlover.walkinappointments.FragmentPetWalkinCompletedAppointment;
import com.triton.healthZ.fragmentpetlover.walkinappointments.FragmentPetWalkinMissedAppointment;
...
public class PetWalkinappointmentsActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener, View.OnClickListener {

    private String TAG = "PetWalkinappointmentsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_walkin_appointments);
...
//        bottom_navigation_view.getMenu().findItem(R.id.home).setChecked(true);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentPetWalkinNewAppointment(), "New");
        adapter.addFragment(new FragmentPetWalkinCompletedAppointment(), "Completed");
        adapter.addFragment(new FragmentPetWalkinMissedAppointment(), "Missed");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(PetWalkinappointmentsActivity.this, PetLoverDashboardActivity.class);
        startActivity(i);
        finish();
    }
    ...
    private void showSOSAlert(List<PetLoverDashboardResponse.DataBean.SOSBean> sosList) {
        ...
        try {
            ...
            dialog = new Dialog(PetWalkinappointmentsActivity.this);
            ...
            btn_call.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(PetWalkinappointmentsActivity.this, new String[]{Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
                    }
                    else
                    {
                        gotoPhone();
