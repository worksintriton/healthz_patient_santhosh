...
import com.triton.healthz.adapter.DoctorPrescriptionsDetailsAdapter;
                ...
                if (response.body() != null) {
                    if(response.body().getCode() == 200){
                        ...
                        if(response.body().getData()!=null) {
                            ...
                            if(response.body().getData().getShare_msg() != null){
                                img_profile.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        try {
                                            ...
                                            String shareMessage= response.body().getData().getShare_msg();
