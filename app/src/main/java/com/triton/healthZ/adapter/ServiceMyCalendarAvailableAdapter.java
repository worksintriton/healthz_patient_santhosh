...
public class ServiceMyCalendarAvailableAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ONE = 1;
    private static final int TYPE_LOADING = 5;
    private  String TAG = "ServiceMyCalendarAvailableAdapter";
    ...
    public ServiceMyCalendarAvailableAdapter(Context context, List<SPAvailableTimeResponse.DataBean.TimesBean> timesBeanList, RecyclerView inbox_list, ServiceAppointment_Doctor_Date_Time_Activity serviceAppointment_doctor_date_time_activity) {
        this.timesBeanList = timesBeanList;
        this.context = context;
        this.mCallback = (OnItemSelectedTime)serviceAppointment_doctor_date_time_activity;
