...
public class DoctorWalkinMissedAppointmentAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "DoctorWalkinMissedAppointmentAdapter";
    ...
    public DoctorWalkinMissedAppointmentAdapter(Context context, List<DoctorAppointmentsResponse.DataBean> missedAppointmentResponseList, RecyclerView inbox_list, int size) {
