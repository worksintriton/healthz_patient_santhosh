...
public class PetWalkinMissedAppointmentAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "PetWalkinMissedAppointmentAdapter";
    ...
    public PetWalkinMissedAppointmentAdapter(Context context, List<PetAppointmentResponse.DataBean> missedAppointmentResponseList, RecyclerView inbox_list, int size) {
