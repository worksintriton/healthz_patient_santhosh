...
public class DoctorWalkinNewAppointmentAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private  String TAG = "DoctorWalkinNewAppointmentAdapter";
    ...
    public DoctorWalkinNewAppointmentAdapter(Context context, List<DoctorAppointmentsResponse.DataBean> newAppointmentResponseList, RecyclerView inbox_list, int size, OnAppointmentCancel onAppointmentCancel, AVLoadingIndicatorView avi_indicator) {
