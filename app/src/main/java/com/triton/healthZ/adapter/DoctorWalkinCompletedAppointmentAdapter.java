...
public class DoctorWalkinCompletedAppointmentAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private  String TAG = "DoctorWalkinCompletedAppointmentAdapter";
    ...
    public DoctorWalkinCompletedAppointmentAdapter(Context context, List<DoctorAppointmentsResponse.DataBean> completedAppointmentResponseList, RecyclerView inbox_list, int size) {
    ...
    private void initLayoutOne(ViewHolderOne holder, final int position) {
        ...
        holder.btn__prescriptiondetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(completedAppointmentResponseList.get(position).get_id() != null) {
                    Intent i = new Intent(context, DoctorWalkinPrescriptionDetailsActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.ll_new.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, DoctorWalkinAppointmentDetailsActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
