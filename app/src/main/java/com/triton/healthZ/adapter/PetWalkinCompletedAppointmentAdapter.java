...
import com.triton.healthZ.customer.PetWalkinAppointmentDetailsActivity;
import com.triton.healthZ.responsepojo.PetAppointmentResponse;

import java.util.List;


public class PetWalkinCompletedAppointmentAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final String TAG = "PetWalkinCompletedAppointmentAdapter";
    ...
    public PetWalkinCompletedAppointmentAdapter(Context context, List<PetAppointmentResponse.DataBean> completedAppointmentResponseList, int size, AddReviewListener addReviewListener) {
